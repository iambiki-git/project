      ...
      <a href="../home/index.php"><img src="../images/newproject.png" alt="clothing store logo" class="myclothinglogo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0 mylink">
            ...
            <li class="nav-item">
              <a class="nav-link" href="female_page.php">Women</a>
            </li>
            <?php
          ...
          <form class="d-flex" role="search" action="men_page.php" method="get">
       ...
       <div class="col-md-2 bg-dark p-0">
        ...
        <ul class="navbar-nav me-auto text-center">
          ...
          <?php
              ...
              while($row_data = mysqli_fetch_assoc($result_brands)){
                ...
                <a href='../Category_men_women/men_page.php?brand=$brand_id' class='nav-link'>$brand_title</a>
              </li>";
              }
          ?>
        </ul>
        ...
        <ul class="navbar-nav me-auto text-center">
          ...
          <?php
              ...
              $select_category = "SELECT * FROM categories WHERE gender = 'male'";
              ...
              while($row_data = mysqli_fetch_assoc($result_category)){
                ...
                echo " <li class='nav-item text-light'>
                <a href='../Category_men_women/men_page.php?category=$category_id' class='nav-link'>$category_title</a>
              </li>";
              }
          ?>         
        </ul>
